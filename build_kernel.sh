...
make -C $(pwd) O=$(pwd)/out $KERNEL_MAKE_ENV CFP_CC=$KERNEL_LLVM_BIN CROSS_COMPILE=$BUILD_CROSS_COMPILE REAL_CC=$KERNEL_LLVM_BIN CLANG_TRIPLE=$CLANG_TRIPLE winnerx_defconfig
